...
Generating a single CLK1/CLK2 pair in a predictable manner defeated me.
The clock board is also susceptible to phantom clock pulses when
halting and resuming.  A new clock board could address these deficiencies.
